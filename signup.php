...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into student(fname,lname,email,password,contact,username,address,dob,level,course,admin_id) values('$fname','$lname','$email','$password','$contact','$username','$address','$dob','$level','$course','$admin_id')");
...
<html lang="en">
    <head>
        ...
        <title>Student Signup | Registration and Login System</title>
...
<div class="col-md-6">
<div class="form-floating mb-3 mb-md-0">
<input class="form-control" id="clas" name="level" type="text" placeholder="Enter your level" required />
<label for="clas">level</label><br>
</div>
</div>
...
<div class="col-md-6">
<div class="form-floating mb-3 mb-md-0">
<input class="form-control" id="clas" name="dob" type="text" placeholder="Enter your date of birth" required />
